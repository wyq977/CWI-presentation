...
%\def\titlefigure{title-page-image}		% use other image
...
\begin{frame}[fragile]{Title page}
	...
	For example:
	\begin{verbatim}
		\def\titlefigure{title-page-image-alt}
	\end{verbatim}
...
\begin{frame}[fragile]{Aspect ratio}
	...
	In this case, you probably want to use the cover image \verb+\def\titlefigure{title-page-image-43}+
	or any other image in 14:10 aspect ratio, for example \verb+\def\titlefigure{title-page-image-alt-43}+
...
\begin{frame}{And, of course, figures!}
	...
	\begin{columns}
		\begin{column}{0.33\textwidth}
			\includegraphics[width=\columnwidth]{helix.pdf}
		\end{column}
		\begin{column}{0.33\textwidth}
